...
![NVIDIA A100 GPU Architecture Diagram](https://github.com/hdimmfh/hdimmfh.github.io/blob/main/_data/blog-img-repo/img/gpu/architecture/CSP-multi-user-with-MIG.png?raw=true)
*Figure 1. NVIDIA A100 GPU Architecture (MIG Example).*

![Memory hierarchy](https://github.com/hdimmfh/hdimmfh.github.io/blob/main/_data/blog-img-repo/img/gpu/architecture/memory-hierarchy-in-gpus.png?raw=true)
...
![HBM Internal Structure](https://github.com/hdimmfh/hdimmfh.github.io/blob/main/_data/blog-img-repo/img/gpu/architecture/HBM-architecture.png?raw=true)
