...
The data path does **not** pass through OpenSM. Instead, OpenSM only manages the control plane of the InfiniBand fabric.
...
One useful way to think about OpenSM is to compare it with a city traffic system. Imagine a newly built city.
