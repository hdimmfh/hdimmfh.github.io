...
From the application's perspective, Unified Memory is simple. The application allocates managed memory, optionally provides memory hints, launches a kernel, and synchronizes when the work is complete.
